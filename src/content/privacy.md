...
Diese Website wird betrieben von der Pipelinr GmbH (FN 1029242f), in der Folge "wir", "uns", und "Pipelinr", mit Sitz in 1010 Wien, Musterstraße 123.
...
auf dieser Website können Sie im Impressum dieser Website einsehen.**

## 1. Erhebung und Verarbeitung personenbezogener Daten

Wenn Nutzerinnen oder Nutzer diese Website besuchen, werden grundsätzlich folgende technisch notwendige Daten verarbeitet: 
...
Diese Daten werden ausschließlich für die technische Bereitstellung, Sicherheit und Funktion der Website verwendet.

Sollten sich Nutzerinnen oder Nutzer dazu entscheiden, sich zu registrieren, um ein Produkt zu erwerben oder ein Formular zu verwenden, 
...
Rechtsgrundlage ist die Einwilligung der Nutzerinnen und Nutzer gemäß Art. 6 Abs. 1 lit. a DSGVO.

## 2. Hosting

Diese Website wird über den Dienst Cloudflare bereitgestellt. 

Cloudflare, Inc. \
101 Townsend St., San Francisco \
CA 94107, USA

Beim Aufruf dieser Website können daher technisch notwendige Daten an Cloudflare übermittelt werden. 
...
* verwendetes Betriebssystem
* Referer-URL
* Informationen zur Erkennung und Abwehr von Angriffen
...
Pipelinr verwendet Stripe für die Zahlungsabwicklung. 
...
Daten, die für die Bereitstellung der Website benötigt werden, werden grundsätzlich für bis zu 14-Tage in unseren Log-Dateien gespeichert.
Sollten Daten aufgrund eines konkreten Sicherheitsvorfalls länger benötigt werden, kann sich die Speicherdauer gegebenenfalls verlängern.
...
Solche Cookies werden nur nach entsprechender Einwilligung gesetzt. 
...
Des Weiteren besteht das Recht, Beschwerde bei der österreichischen Datenschutzbehörde einzureichen.
